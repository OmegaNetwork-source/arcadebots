...
export class VictoryUIScene extends Phaser.Scene {
  ...
  setupInputs(): void {
    ...
    this.input.on('pointerdown', () => this.goToNextLevelWithSound());

    // Listen for key events
    this.enterKey.on('down', () => this.goToNextLevelWithSound());
    this.spaceKey.on('down', () => this.goToNextLevelWithSound());
  }
