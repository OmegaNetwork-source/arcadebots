...
export class GameCompleteUIScene extends Phaser.Scene {
  ...
  setupInputs(): void {
    ...
    this.input.on('pointerdown', () => this.returnToMenuWithSound());

    // Listen for key events
    this.enterKey.on('down', () => this.returnToMenuWithSound());
    this.spaceKey.on('down', () => this.returnToMenuWithSound());
  }
